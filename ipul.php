...
<body background="bc.png">
    <div class="wrap">
        ...
        <div class="header">          
            <h1><font face="Century Gothic">Selamat Datang </font></h1>
            <div class="tanggal">
                <?php
                    // Real Time Clock
                    echo date('d F Y');
        ...
        <div class="content"><center>
            ...
            <table>
                <tr><td>Nama</td><td>:</td><td>Syaiful Bahri</td></tr>
                <tr><td>NIM</td><td>:</td><td>11180910000034</td></tr>
